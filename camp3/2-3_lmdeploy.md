...
![image-20240812133248530](2-3_lmdeploy.assets/image-20240812133248530.png)
...
使用了量化模型和设置 `--cache-max-entry-count 0.4`，占用显存大约 13.5G
...
![image-20240812165931387](2-3_lmdeploy.assets/image-20240812165931387.png)
