...
**InternLM2案例分析：** 工具调用使用了如`<|plugin|>`、`<|interpreter|>`、`<|action_start|>`和`<|action_end|>`等特殊标记，确保每个调用都符合指定的格式。模型在执行任务时，依靠这些标记与系统紧密协作，保障任务的精准执行。文档链接：[InternLM-Chat Agent](https://github.com/InternLM/InternLM/tree/main/agent)
...
![image-20241123102734088](2-2_lagent.assets/image-20241123102734088.png)
...
![image-20241123150804307](2-2_lagent.assets/image-20241123150804307.png)
...
问题：帮我搜索一下最新版本的MindSearch论文

不使用 **ArxivSearch** 能力

![image-20241123151709348](2-2_lagent.assets/image-20241123151709348.png)

使用 **ArxivSearch** 能力

![image-20241123151925398](2-2_lagent.assets/image-20241123151925398.png)
...
![image-20241123152212976](2-2_lagent.assets/image-20241123152212976.png)
...
![image-20241123153055323](2-2_lagent.assets/image-20241123153055323.png)
...
![image-20241123152509551](2-2_lagent.assets/image-20241123152509551.png)
...
可以看到左侧的插件栏多了天气查询插件，勾选插件后可以获得正确的天气信息

问题：帮我查询一下南京现在的天气

![image-20241123153600438](2-2_lagent.assets/image-20241123153600438.png)
...
![image-20241123153749682](2-2_lagent.assets/image-20241123153749682.png)
...
![image-20241123154237914](2-2_lagent.assets/image-20241123154237914.png)
...
![image-20241123154413709](2-2_lagent.assets/image-20241123154413709.png)

第一步生成的结果：

![image-20241123154436456](2-2_lagent.assets/image-20241123154436456.png)

第二步批评和文献检索的结果：

![image-20241123154450624](2-2_lagent.assets/image-20241123154450624.png)

第三步最后完善的内容，可以看到其中包括了检索得到的文献，使得博客内容更加具有可信度。

![image-20241123154529489](2-2_lagent.assets/image-20241123154529489.png)